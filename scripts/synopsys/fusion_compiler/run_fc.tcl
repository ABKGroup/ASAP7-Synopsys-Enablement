...
set TECH_FILE "${PDK_DIR}/tf/asap7_1x.tf"
set MACRO_LEF_FILE "${PDK_DIR}/lef/asap7sc7p5t_28_R_1x_220121a.lef [glob "${PDK_DIR}/lef/sram*.lef"]"
set TLUP_FILE "${PDK_DIR}/tlup/asap7_1x.tlup"
set LAYERMAP_FILE "${PDK_DIR}/tlup/asap7.layermap"

create_lib -technology ${TECH_FILE} -ref_libs ${MACRO_LEF_FILE} ASAP7
...
read_def -convert_sites {asap7sc7p5t unit} -design ${DESIGN} ${DEF_FILE}
...
set_voltage 0.77 -corner [current_corner] -object_list [get_supply_nets VDD]
...
exec mv ${DESIGN}_CC_${CC}.WS_0.spef ${DESIGN_DIR}/${DESIGN}_${PEX}_CC_${CC}.spef
